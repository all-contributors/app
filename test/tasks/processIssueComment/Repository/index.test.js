...
describe("Repository", () => {
  ...
  test("createPullRequest with files", async () => {
    nock("https://api.github.com")
      .get(`/repos/all-contributors/all-contributors-bot/git/refs/heads/master`)
      .reply(200, gitGetRefdata);

    nock("https://api.github.com")
      .post(`/repos/all-contributors/all-contributors-bot/git/refs`, verifyBody)
    ...
    nock("https://api.github.com")
      .post(`/repos/all-contributors/all-contributors-bot/pulls`, verifyBody)
